...
public class TechRootMenuAdapter extends CursorAdapter{

private Handler mHandler=null;
	    public TechRootMenuAdapter(Context context, Cursor cursor,Handler handler) {
        ...
        {  
    		...
    		View inflateLayout  = inflater.inflate(R.layout.item_list_tech_root_menu,null);   
