...
public class UserActivity extends RootActivity implements CallInterface {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main_tech);
		initUI();
		mIntent=getIntent();
		getData();
		// initObserver();
...
void getData()
{
	...
	public void ShowTabMenuTechClass() {
		if (mTabMenuTechClass != null) {
			if (mTabMenuTechClass.isShowing())
				...
				mTabMenuTechClass.showAtLocation(this.getWindow().getDecorView(),
						Gravity.TOP, 0, 0);
			}
		}
	}
	...
	public void ShowTabMenuTS() {
		if (mTabMenuTSClass != null) {
			if (mTabMenuTSClass.isShowing())
				...
				mTabMenuTSClass.showAtLocation(this.getWindow().getDecorView(),
						Gravity.TOP, 0, 0);
			}
		}
	}
	...
	void initTSMenuList() {
		...
		Button b = (Button) findViewById(R.id.id_b_teach_study);
		b.setText((String)(records.get(0)));

		if (mMenuAdapterTSClass == null) {
			mMenuAdapterTSClass = new TechTabMenuPopupWindow.TechMenuAdapter(this,
					menuTSClickListener, records, recordsId);
			if (mTabMenuTSClass == null) {
				mTabMenuTSClass = new TechTabMenuPopupWindow(this, null,
	...
	void initTechClassMenuList() {
		...
		Button b = (Button) findViewById(R.id.id_b_tech_class);
		b.setText(tech);
		...
		if (mMenuAdapterTechClass == null) {
			mMenuAdapterTechClass = new TechTabMenuPopupWindow.TechMenuAdapter(this,
					menuTechClassClickListener, recordsTech, recordsTechId);
			if (mTabMenuTechClass == null) {
				mTabMenuTechClass = new TechTabMenuPopupWindow(this, null,
						R.drawable.menu_bg, R.style.PopupAnimation);
    ...
    {
        Intent intentv = new Intent(this, UserDetailActivity.class); 
	...
	void initUI() {
		mListView = (ListView) findViewById(R.id.id_list_tech_listview);
		...
		mAdapter = new UserAdapter(this, mChangeCursor, mHandler);
		...
		Button btns = null;
		btns = (Button) findViewById(R.id.id_b_tech_class);
		...
		btns = (Button) findViewById(R.id.id_b_teach_study);
		btns.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
	...
	void hideEmptyFooter() {
		View v = (View) findViewById(R.id.id_ll_empty_progress);
	...
	public Cursor getCursor() {
		...
		String where = null;
		return mChangeCursor = getContentResolver().query(
	...
	void startGetUserByTech() {
		...
		HttpGetAsyncTask t = new HttpGetAsyncTask(UserActivity.this,
				UserActivity.this, null, R.string.app_name, R.string.app_name,
				null);
	...
	public void PostSyncTaskCall(String other, String res, Object otherObject) {
		...
		if (res != null) {
			...
			if (result.equalsIgnoreCase("success")) {
				unInitObserver();
				ContentProviderUtil.insertSimpleUsersJson(this, rm.mData);
				initObserver();
				updateAdapterCursor();
	...
	public void finishAndReturn() {
		Intent intent = null;
		intent = new Intent(this, TechMainActivity.class);
