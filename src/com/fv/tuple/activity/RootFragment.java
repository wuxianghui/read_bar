 ...
 */								   
public class RootFragment extends Fragment implements DownloadAsyncTaskPoolInterface,DownloadCallInterface{
    ...
    public void initDP()
    {
    	mDP=new DownloadAsyncTaskPool(this.getActivity(),this);
    }
...
public AsyncTask startOneTask(DownloadAsyncTaskPoolElement task) {
	// TODO Auto-generated method stub
	// TODO Auto-generated method stub
	DownloadAsyncTask t=new DownloadAsyncTask(this.getActivity(),this,task);
